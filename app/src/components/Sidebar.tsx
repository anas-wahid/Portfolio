    ...
    <>
      ...
      <aside className="sidebar-fixed bg-[#0B0C0E] border-r border-white/[0.06] flex flex-col justify-between py-8 px-4">
            ...
            {navLinks.map((link, i) => {
              ...
              return (
                <motion.button
                  ...
                  animate={{ opacity: 1, x: 0 }}
                  transition={{ duration: 0.35, delay: 0.08 + i * 0.03, ease: "easeInOut" }}
                  onClick={() => scrollTo(link.href)}
                  className={`flex items-center gap-3 py-2.5 px-3 rounded-lg text-left transition-all duration-200 ease-in-out group cursor-pointer ${
                    isActive
                ...
                >
                  <span
                    className={`text-[10px] font-mono font-bold tracking-wider transition-colors duration-200 ease-in-out ${
        ...
        <motion.button
          ...
          className="flex items-center gap-2 text-white/25 hover:text-white/50 transition-colors duration-200 ease-in-out text-xs group cursor-pointer"
        >
          <Command className="w-3.5 h-3.5" />
          <span className="font-medium">Navigate</span>
          <kbd className="ml-auto px-1.5 py-0.5 rounded bg-white/[0.06] border border-white/[0.08] text-[10px] font-mono text-white/30 group-hover:text-white/50 transition-colors duration-200 ease-in-out">
            ⌘K
          </kbd>
        </motion.button>
      </aside>
        ...
        <div className="flex items-center justify-between px-4 h-14">
          ...
          <div className="flex items-center gap-3">
            ...
            <button
              ...
              className="w-8 h-8 flex items-center justify-center rounded-lg bg-white/[0.05] text-white/60 cursor-pointer active:scale-95 transition-all duration-200 ease-in-out"
            >
        ...
        {mobileMenuOpen && (
          ...
          >
              ...
              {navLinks.map((link) => {
                ...
                return (
                  <button
                    key={link.href}
                    onClick={() => scrollTo(link.href)}
                    className={`flex items-center gap-3 py-2.5 px-3 rounded-lg text-left transition-all duration-200 ease-in-out ${
                      isActive
                        ? 'bg-white/[0.06] text-white'
                  ...
                  >
                    <span
                      className={`text-[10px] font-mono font-bold transition-colors duration-200 ease-in-out ${
            ...
            <button
              ...
              className="flex items-center gap-2 text-white/25 hover:text-white/50 text-xs mt-3 px-3 py-2 transition-colors duration-200 ease-in-out cursor-pointer"
            >
